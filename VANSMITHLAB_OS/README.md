...
| Knowledge and trust | `03_KNOWLEDGE_MODEL.md`, `04_DATA_ARCHITECTURE.md`, `05_EVIDENCE_POLICY.md`, `06_CONTENT_MODEL.md` |
| Taxonomy and authoring format | `TAXONOMY.md`, `DOCX_SCHEMA.md` |
| Language, media and AI | `07_LANGUAGE_SYSTEM.md`, `08_MEDIA_AND_RIGHTS.md`, `09_AI_OPERATING_MODEL.md`, `10_AUTOMATION_AND_ESCALATION.md` |
