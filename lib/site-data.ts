...
export const copy: Record<Locale, Copy> = {
  ru: {
    ...
    section: {
      ...
      "glossary/designers": { eyebrow: "Модельеры", title: "Модельеры", text: "Биографические и визуально-аналитические материалы о модельерах, чьи методы сформировали язык современной моды.", items: ["Мода"] },
